...
public class FieldConstants {
  ...
  public static final int aprilTagCount = AllianceUtils.getFieldLayout().getTags().size();
  public static final double aprilTagWidth = Units.inchesToMeters(6.5);

  // Field dimensions
  public static final double fieldLength = AllianceUtils.getFieldLayout().getFieldLength();
  public static final double fieldWidth = AllianceUtils.getFieldLayout().getFieldWidth();
  ...
  public static class LinesVertical {
    ...
    public static final double starting =
        AllianceUtils.getFieldLayout().getTagPose(26).get().getX();
    public static final double allianceZone = starting;
    public static final double hubCenter =
        AllianceUtils.getFieldLayout().getTagPose(26).get().getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter =
        AllianceUtils.getFieldLayout().getTagPose(4).get().getX() + Hub.width / 2.0;
    public static final double oppAllianceZone =
        AllianceUtils.getFieldLayout().getTagPose(10).get().getX();
  }
  ...
  public static class Hub {
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            AllianceUtils.getFieldLayout().getTagPose(26).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
    ...
    public static final Translation3d oppTopCenterPoint =
        new Translation3d(
            AllianceUtils.getFieldLayout().getTagPose(4).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
    ...
    public static final Pose2d nearFace =
        AllianceUtils.getFieldLayout().getTagPose(26).get().toPose2d();
    public static final Pose2d farFace =
        AllianceUtils.getFieldLayout().getTagPose(20).get().toPose2d();
    public static final Pose2d rightFace =
        AllianceUtils.getFieldLayout().getTagPose(18).get().toPose2d();
    public static final Pose2d leftFace =
        AllianceUtils.getFieldLayout().getTagPose(21).get().toPose2d();
  }
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(frontFaceX, AllianceUtils.getFieldLayout().getTagPose(31).get().getY());
    public static final Translation2d leftUpright =
        new Translation2d(
            frontFaceX,
            (AllianceUtils.getFieldLayout().getTagPose(31).get().getY())
                + innerOpeningWidth / 2
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(
            fieldLength - frontFaceX, AllianceUtils.getFieldLayout().getTagPose(15).get().getY());
    public static final Translation2d oppLeftUpright =
        new Translation2d(
            fieldLength - frontFaceX,
            (AllianceUtils.getFieldLayout().getTagPose(15).get().getY())
                + innerOpeningWidth / 2
                + Units.inchesToMeters(0.75));
  ...
  public static class Outpost {
    ...
    // Relevant reference points on alliance side
    public static final Translation2d centerPoint =
        new Translation2d(0, AllianceUtils.getFieldLayout().getTagPose(29).get().getY());
  }
}
