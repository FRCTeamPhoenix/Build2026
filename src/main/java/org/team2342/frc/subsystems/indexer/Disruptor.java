...
public class Disruptor extends SubsystemBase{
    ...
    public Command in() {
        return run(() -> motor.runVoltage(IndexerConstants.DISRUPTOR_RUN_VOLTAGE)).withName("Disruptor Feed");
    }

    public Command reverse() {
        return run(() -> motor.runVoltage(-IndexerConstants.DISRUPTOR_RUN_VOLTAGE)).withName("Disruptor Reverse");
    }
    public Command stop() {
